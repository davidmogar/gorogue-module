...
1. [Setup - The basics of getting started with rogue](#setup)
    * [What rogue affects](#what-rogue-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with rogue](#beginning-with-rogue)
